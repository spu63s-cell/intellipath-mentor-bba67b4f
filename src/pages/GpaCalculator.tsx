...
import { 
  ...
  GraduationCap, Target, Award, RotateCcw, Download, BookOpen
} from 'lucide-react';
...
export default function GpaCalculator() {
  ...
  const texts = {
    ...
    subtitle: isRTL ? 'احسب معدلك التراكمي بسهولة' : 'Calculate your GPA easily',
    ...
    calculate: isRTL ? 'احسب المعدل' : 'Calculate GPA',
